    ...
    <div>
      ...
      <div className="h-full w-full bg-gradient-to-r from-midnight to-night  relative items-center justify-center">
        ...
        <p className="lg:text-3xl md:text-2xl sm:2xl text-silver text-justify mx-4 p-12 tracking-wide font-semibold">
          The FARHANA CHARITABLE ORGANIZATION (FCO) is a non-profit organization
          committed to positively impacting education and health in Zanzibar.
          FCO operates as a society-type organization, serving the community and
          prioritizing the welfare of individuals. Focusing on the entire
          region, FCO implements programs and initiatives to support those in
          need. By providing education opportunities and promoting healthcare,
          FCO empowers individuals, enhances quality of life, and fosters
          lasting societal change. Through their dedicated efforts, FCO is
          dedicated to building a brighter future for the people of Zanzibar.
        </p>
        <div>
