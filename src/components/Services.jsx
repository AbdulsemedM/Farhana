        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 p-6">
          <div>
            <Card
              ...
              description={`In the heart of the beautiful island of Zanzibar, where pristine beaches meet vibrant culture, a local charity organization embarked on a mission to empower the young minds of the community. Recognizing the significance of education and spiritual nourishment, the organization decided to donate Qurans as a form of charity to children in need. This act of kindness not only provided access to a sacred text but also ignited a profound impact on their lives. Let us delve into the story of how this Quran charity project touched the hearts of children in Zanzibar.
    
    The impact of the Quran charity project was profound, touching the lives of countless children in Zanzibar. For many, it was their first personal copy of the Quran, a possession they could call their own. The children eagerly embraced this gift, embracing the opportunity to explore its teachings, recite verses, and develop a deeper understanding of their faith.
    ...
    Beyond the spiritual aspect, the Qurans also played a significant role in enhancing their educational journey. With limited access to educational resources, the children found solace and enrichment in the verses of the Quran. They discovered stories of prophets, lessons of morality, and guidance for leading a righteous life. The project not only provided a valuable resource for their religious studies but also instilled a love for reading, critical thinking, and personal growth.`}
          ...
          <div>
            <Card
              image={img.hlp2}
              title={
                " Quenching Thirst : Clean Tap Water Project Transforms a Local Zanzibar Community"
              }
              description={`Access to clean and safe drinking water is a fundamental human right, yet many communities around the world still struggle with this basic necessity. In the enchanting island of Zanzibar, a local initiative took root to address this pressing issue and bring clean tap water to a community in need. This blog highlights the remarkable journey of the clean tap water project and its transformative impact on the lives of the local residents.
          ...
          <div>
            <Card
              image={img.hlp3}
              title={
                "Spreading Joy and Festivity: Clothing Drive Brings Eid al-Fitr Delight to Zanzibar's Local Children"
              }
              description={`Eid al-Fitr, a joyous celebration marking the end of Ramadan, holds a special place in the hearts of Muslims around the world. In the vibrant streets of Zanzibar, a local initiative set out to make this festive occasion even more memorable for the underprivileged children of the community. Through a heartwarming clothing drive, the project aimed to bring smiles, confidence, and a sense of belonging to these young souls. Join us as we delve into the story of how this initiative ignited the spirit of Eid and embraced the local children in Zanzibar.
          ...
          <div>
            <Card
              image={img.hlp4}
              title={
                "Nourishing Hearts: Feeding Children during Eid al-Fitr Festival in Zanzibar"
              }
              description={`Eid al-Fitr, a time of celebration and gratitude, holds a special place in the hearts of Muslims around the world. In the vibrant community of Zanzibar, a local initiative embraced the spirit of generosity by providing nourishing meals to underprivileged children during the festive occasion. This blog recounts the inspiring story of how this feeding program brought joy, sustenance, and a sense of togetherness to the local children, making their Eid al-Fitr truly memorable.
          ...
          <div>
            <Card
              image={img.hlp7}
              title={
                "Spreading Joy and Sharing Blessings: Distributing Zakat al-Fitr to Zanzibar's Local Children"
              }
              description={`Zakat al-Fitr, also known as Fitrana or Sadaqat al-Fitr, is a special charitable contribution given during the auspicious time of Eid al-Fitr. In the enchanting island of Zanzibar, the local community comes together to embrace the spirit of giving by distributing Zakat al-Fitr to the underprivileged children. This blog encapsulates the heartwarming story of how this act of generosity brings smiles, joy, and blessings to the lives of the local children in Zanzibar.
              Distributing Zakat al-Fitr in Zanzibar unifies the community and strengthens the bonds of brotherhood and sisterhood. People from all walks of life, irrespective of their economic backgrounds, contribute their share of Zakat al-Fitr, recognizing the importance of collective responsibility in uplifting those who are less fortunate. The act of giving becomes a testament to the community's compassion and commitment to ensuring that every child experiences the joy of Eid.
          ...
          <div>
            <Card
              image={img.hlp8}
              title={
                "Nurturing Hearts and Guiding Minds: Care and Parenting in Zanzibar's Local Community"
              }
              description={`Parenting is a universal journey filled with love, challenges, and the desire to provide the best for our children. In the vibrant community of Zanzibar, parents and caregivers are committed to nurturing the young minds and hearts of their children. This blog explores the beautiful tapestry of care and parenting practices in the local community, highlighting the values, traditions, and collective efforts that shape the upbringing of children in Zanzibar.
              In Zanzibar, parenting goes beyond the immediate family unit. The community plays an integral role in the care and upbringing of children. Neighbors, extended family members, and close friends form a network of support, sharing wisdom, advice, and resources. This collective approach creates a sense of belonging and ensures that children grow up surrounded by love, guidance, and multiple role models.
              In Zanzibar, emotional well-being holds significant importance in parenting. Parents and caregivers actively listen to their children, creating an atmosphere of trust and open communication. Emotional expression is encouraged, and children are taught empathy, compassion, and resilience. This emphasis on emotional nurturing helps children develop healthy relationships, build self-confidence, and navigate life's challenges.`}
            />
          </div>
        </div>
      </div>
